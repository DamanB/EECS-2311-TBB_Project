 ...
 *         <p>
 *         <p>
 *         This class is used in ScenarioCreatorManager in the list of
 *         Question's. Each Question has a list of commands which correlates to
 *         one line in the Scenario file. This class is used to keep track of
 *         the editing of Scenario Files and checks if each command has a valid
 *         input. If not it will throw an exception.
 */
